...
# HTML template (translated from French to English)
HTML_TEMPLATE = """
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
    ...
    {% if images %}
        ...
        {% endfor %}
    {% else %}
        <p>No images matching the filters.</p>
    {% endif %}
    </ul>
</body>
</html>
...
def change_status(filename):
    ...
    if os.path.exists(new_path):
        return "File name already exists", 400
...
def weekly_cleanup():
    # Schedule weekly cleanup every Sunday
    while True:
        now = datetime.now()
...
def clear_upload_folder():
    # Delete and recreate upload folder
